...
import org.nakii.mmorpg.quest.menu.betonquest.MenuConditionFactory;
import org.nakii.mmorpg.quest.menu.betonquest.MenuEventFactory;
import org.nakii.mmorpg.quest.menu.betonquest.MenuObjectiveFactory;
import org.nakii.mmorpg.quest.menu.betonquest.MenuVariableFactory;
import org.nakii.mmorpg.quest.menu.command.RPGMenuCommand;
import org.nakii.mmorpg.quest.menu.event.MenuOpenEvent;
import org.nakii.mmorpg.quest.menu.kernel.MenuItemListener;
import org.nakii.mmorpg.quest.menu.kernel.MenuItemProcessor;
import org.nakii.mmorpg.quest.menu.kernel.MenuProcessor;
...
public class RPGMenu {
    ...
    public RPGMenu(final BetonQuestLogger log, final BetonQuestLoggerFactory loggerFactory,
        ...
        final QuestTypeRegistries questRegistries = questModule.getQuestRegistries();
        final Server server = MMORPGCore.getInstance().getServer();
        final PrimaryServerThreadData data = new PrimaryServerThreadData(server, server.getScheduler(), MMORPGCore.getInstance());
        ...
        questModule.addProcessor(menuItemProcessor);
        ...
        questModule.addProcessor(menuProcessor);
        ...
        server.getPluginManager().registerEvents(menuItemListener, MMORPGCore.getInstance());
    }
    ...
    public void onDisable() {
        ...
        HandlerList.unregisterAll(MMORPGCore.getInstance());
