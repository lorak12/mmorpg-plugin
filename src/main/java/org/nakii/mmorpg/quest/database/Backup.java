...
public final class Backup {
     ...
     */
    private static final BetonQuestLogger LOG = MMORPGCore.getInstance().getQuestModule().getLoggerFactory().create(Backup.class);
    ...
    public static boolean backupDatabase(final ConfigAccessorFactory configAccessorFactory, final File databaseBackupFile) {
        ...
        try {
            ...
            final File brokenFile = new File(MMORPGCore.getInstance().getDataFolder(), "database-backup.yml");
    ...
    public static void loadDatabaseFromBackup(final ConfigAccessorFactory configAccessorFactory) {
        final QuestModule instance = MMORPGCore.getInstance().getQuestModule();
        final File file = new File(MMORPGCore.getInstance().getDataFolder(), "database-backup.yml");
        ...
        // backup the database
        final File backupFolder = new File(MMORPGCore.getInstance().getDataFolder(), "Backups");
