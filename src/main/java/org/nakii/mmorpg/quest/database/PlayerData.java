package org.nakii.mmorpg.quest.database;
...
import org.nakii.mmorpg.quest.api.bukkit.event.PlayerTagAddEvent;
import org.nakii.mmorpg.quest.api.bukkit.event.PlayerTagRemoveEvent;
import org.nakii.mmorpg.quest.api.bukkit.event.PlayerUpdatePointEvent;
...
import org.nakii.mmorpg.quest.conversation.PlayerConversationState;
...
public class PlayerData implements TagData, PointData {
    ...
    private void setupProfile() {
        ...
        saver.add(new Record(UpdateType.ADD_PLAYER_PROFILE, profile.getPlayer().getUniqueId().toString(),
                profileID, MMORPGCore.getInstance().getQuestModule().getPluginConfig().getString("profile.initial_name", "default")));
    }
