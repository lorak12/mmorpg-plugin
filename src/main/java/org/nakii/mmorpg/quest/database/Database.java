...
public abstract class Database {
     ...
     */
    protected Database(final BetonQuestLogger log, final MMORPGCore plugin) {
        this.log = log;
        this.plugin = plugin;
        this.prefix = plugin.getQuestModule().getPluginConfig().getString("mysql.prefix", "");
        this.profileInitialName = plugin.getQuestModule().getPluginConfig().getString("profile.initial_name", "default");
    }
