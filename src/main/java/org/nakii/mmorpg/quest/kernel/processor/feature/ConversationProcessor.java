...
import org.nakii.mmorpg.quest.kernel.registry.feature.ConversationIORegistry;
import org.nakii.mmorpg.quest.kernel.registry.feature.InterceptorRegistry;
...
public class ConversationProcessor extends SectionProcessor<ConversationID, ConversationData> {
    ...
    public ConversationProcessor(final BetonQuestLogger log, final BetonQuestLoggerFactory loggerFactory,
                                 final QuestModule plugin, final ParsedSectionTextCreator textCreator,
    ...
    protected ConversationData loadSection(final QuestPackage pack, final ConfigurationSection section) throws QuestException {
        ...
        final boolean invincible = plugin.getPluginConfig().getConfig().getBoolean("conversation.damage.invincible");
