package org.nakii.mmorpg.quest.kernel.processor.quest;

import org.nakii.mmorpg.MMORPGCore;
import org.nakii.mmorpg.quest.QuestModule;
import org.nakii.mmorpg.quest.api.bukkit.event.npc.NpcInteractEvent;
...
import org.nakii.mmorpg.quest.api.quest.npc.feature.NpcConversation;
...
import org.nakii.mmorpg.quest.kernel.registry.quest.NpcTypeRegistry;
...
public class NpcProcessor extends TypedQuestProcessor<NpcID, NpcWrapper<?>> {
    ...
    public NpcProcessor(final BetonQuestLogger log, final BetonQuestLoggerFactory loggerFactory,
                        ...
                        final NpcTypeRegistry npcTypes, final PluginMessage pluginMessage, final QuestModule plugin,
                        final ProfileProvider profileProvider, final QuestTypeApi questTypeApi) {
        super(log, packManager, npcTypes, "Npc", "npcs");
        this.loggerFactory = loggerFactory;
        this.pluginMessage = pluginMessage;
        this.plugin = plugin;
        MMORPGCore.getInstance().getServer().getPluginManager().registerEvents(new NpcListener(), MMORPGCore.getInstance());
    ...
    public void clear() {
        ...
        npcHider.reload(packManager.getPackages().values(), updateInterval, MMORPGCore.getInstance());
    }
