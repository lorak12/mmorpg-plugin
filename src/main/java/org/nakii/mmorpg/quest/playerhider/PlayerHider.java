package org.nakii.mmorpg.quest.playerhider;
...
public class PlayerHider {
     ...
     */
    public PlayerHider(final Plugin plugin, final QuestModule api, final VariableProcessor variableProcessor, final ProfileProvider profileProvider) throws QuestException {
        this.plugin = plugin;
