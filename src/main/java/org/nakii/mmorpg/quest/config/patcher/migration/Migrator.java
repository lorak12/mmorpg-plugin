...
import org.nakii.mmorpg.quest.config.patcher.migration.migrator.from1to2.PackageStructure;
import org.nakii.mmorpg.quest.config.patcher.migration.migrator.from1to2.RPGMenuMerge;
import org.nakii.mmorpg.quest.config.patcher.migration.migrator.from2to3.DeleteMenuConfigYml;
import org.nakii.mmorpg.quest.config.patcher.migration.migrator.from2to3.DeleteMessagesYml;
import org.nakii.mmorpg.quest.config.patcher.migration.migrator.from2to3.MenuConversationSettings;
