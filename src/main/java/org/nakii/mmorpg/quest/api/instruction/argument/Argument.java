package org.nakii.mmorpg.quest.api.instruction.argument;

import org.nakii.mmorpg.MMORPGCore;
import org.nakii.mmorpg.quest.QuestModule;
import org.nakii.mmorpg.quest.api.instruction.argument.types.*;
import org.nakii.mmorpg.quest.api.instruction.argument.types.location.LocationParser;
import org.nakii.mmorpg.quest.api.instruction.argument.types.location.VectorParser;
import org.nakii.mmorpg.quest.api.instruction.argument.types.location.WorldParser;
import org.nakii.mmorpg.quest.api.instruction.variable.VariableResolver;
...
public interface Argument<T> extends VariableResolver<T> {
     ...
     */
    TextParserToComponentParser MESSAGE = new TextParserToComponentParser(MMORPGCore.getInstance().getQuestModule().getTextParser());
