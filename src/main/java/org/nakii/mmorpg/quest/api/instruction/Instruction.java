...
import org.nakii.mmorpg.quest.api.identifier.NoID;
...
import org.nakii.mmorpg.quest.api.instruction.argument.parser.ArgumentConverter;
import org.nakii.mmorpg.quest.api.instruction.argument.parser.IdentifierArgumentConverter;
import org.nakii.mmorpg.quest.api.instruction.argument.parser.PackageArgumentConverter;
import org.nakii.mmorpg.quest.api.instruction.tokenizer.QuotingTokenizer;
import org.nakii.mmorpg.quest.api.instruction.tokenizer.Tokenizer;
import org.nakii.mmorpg.quest.api.instruction.tokenizer.TokenizerException;
...
public class Instruction implements InstructionParts, ArgumentConverter, PackageArgumentConverter, IdentifierArgumentConverter {
    ...
    public <T> Variable<T> get(@Nullable final String string, final Argument<T> argument, @Nullable final T defaultValue) throws QuestException {
        ...
        return new Variable<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, argument);
    }
    ...
    public <T> Variable<List<T>> getList(@Nullable final String string, final Argument<T> argument, final ValueChecker<List<T>> valueChecker) throws QuestException {
        ...
        return new VariableList<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, argument, valueChecker);
    }
    ...
    public <T> Variable<T> get(@Nullable final String string, final PackageArgument<T> argument, @Nullable final T defaultValue) throws QuestException {
        ...
        return new Variable<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, value -> argument.apply(pack, value));
    }
    ...
    public <T> Variable<List<T>> getList(@Nullable final String string, final PackageArgument<T> argument, final ValueChecker<List<T>> valueChecker) throws QuestException {
        ...
        return new VariableList<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, value -> argument.apply(pack, value), valueChecker);
    }
    ...
    public <T> Variable<T> get(@Nullable final String string, final IdentifierArgument<T> argument, @Nullable final T defaultValue) throws QuestException {
        ...
        return new Variable<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, value -> argument.apply(packManager, pack, value));
    }
    ...
    public <T> Variable<List<T>> getList(@Nullable final String string, final IdentifierArgument<T> argument, final ValueChecker<List<T>> valueChecker) throws QuestException {
        ...
        return new VariableList<>(MMORPGCore.getInstance().getQuestModule().getVariableProcessor(), pack, string, value -> argument.apply(packManager, pack, value), valueChecker);
    }
}
