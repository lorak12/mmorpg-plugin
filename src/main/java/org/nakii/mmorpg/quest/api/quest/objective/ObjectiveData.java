...
import org.nakii.mmorpg.quest.api.bukkit.event.QuestDataUpdateEvent;
...
public class ObjectiveData {
    ...
    protected final void update() {
        ...
        MMORPGCore.getInstance().getServer().getScheduler().runTask(MMORPGCore.getInstance(), event::callEvent);
