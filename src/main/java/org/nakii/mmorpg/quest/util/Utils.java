...
import org.nakii.mmorpg.quest.config.Zipper;
import org.nakii.mmorpg.quest.database.Backup;
...
public final class Utils {
     ...
     */
    private static final BetonQuestLogger LOG = MMORPGCore.getInstance().getQuestModule().getLoggerFactory().create(Utils.class);
     ...
     *                              {@link org.nakii.mmorpg.quest.api.config.ConfigAccessor}s
    ...
    public static boolean isQuestItem(@Nullable final ItemStack item) {
        ...
        try {
            final Component questItemLore = MMORPGCore.getInstance().getQuestModule().getPluginMessage().getMessage(null, "quest_item");
