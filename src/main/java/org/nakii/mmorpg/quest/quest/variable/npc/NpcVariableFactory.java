...
import org.nakii.mmorpg.quest.quest.variable.name.QuesterVariable;
 ...
 *
 * @see org.nakii.mmorpg.quest.quest.variable.location.LocationVariable
 */
public class NpcVariableFactory implements PlayerVariableFactory, PlayerlessVariableFactory {
    ...
    private NullableVariable parseInstruction(final Instruction instruction) throws QuestException {
        ...
        final Argument key = instruction.get(org.nakii.mmorpg.quest.api.instruction.argument.Argument.ENUM(Argument.class)).getValue(null);
