package org.nakii.mmorpg.quest.web.updater;
...
public class Updater {
    ...
    public Updater(final BetonQuestLogger log, final UpdaterConfig config, final Version currentVersion,
                   ...
                   final QuestModule plugin, final BukkitScheduler scheduler, final InstantSource instantSource) {
        this.log = log;
        this.config = config;
    ...
    public final void search() {
        ...
        scheduler.runTaskAsynchronously(MMORPGCore.getInstance(), () -> {
            if (searchUpdate()) {
