...
public class Backpack implements Listener {
    ...
    public Backpack(final ConfigAccessor config, final PluginMessage pluginMessage, final OnlineProfile onlineProfile, final DisplayType type) {
        ...
        final QuestModule instance = MMORPGCore.getInstance().getQuestModule();
    ...
    private class BackpackPage extends Display {
        ...
        public BackpackPage(final int page) {
            ...
            Bukkit.getPluginManager().registerEvents(Backpack.this, MMORPGCore.getInstance());
        }
        ...
        private Pair<ItemStack, Boolean> button(final String button, final Material fallback) {
            ...
            if (buttonString != null && !buttonString.isEmpty()) {
                ...
                try {
                    ...
                    stack = MMORPGCore.getInstance().getQuestModule().getFeatureApi().getItem(itemId, onlineProfile).generate(1);
                } catch (final QuestException e) {
    ...
    private class Cancelers extends Display {
        ...
        public Cancelers() {
            ...
            for (final Map.Entry<QuestCancelerID, QuestCanceler> entry : MMORPGCore.getInstance().getQuestModule().getFeatureApi().getCancelers().entrySet()) {
                try {
    ...
    private class Compass extends Display {
        ...
        public Compass() {
            super();
            int counter = 0;
            final FeatureApi featureApi = MMORPGCore.getInstance().getQuestModule().getFeatureApi();
        ...
        private ItemStack[] getContent(final int numberOfRows) {
            ...
            for (final Map.Entry<Integer, QuestCompass> entry : compasses.entrySet()) {
                ...
                ItemStack compass;
                try {
                    compass = MMORPGCore.getInstance().getQuestModule().getFeatureApi().getItem(item, onlineProfile).generate(1);
                } catch (final QuestException e) {
